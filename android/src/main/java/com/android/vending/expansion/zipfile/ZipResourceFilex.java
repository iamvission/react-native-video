...
public class ZipResourceFilex {
    ...
    public ZipResourceFilex(String zipFileName) throws IOException {
    ...
    /**
     * getAssetFileDescriptor allows for ZipResourceFilex to directly feed
