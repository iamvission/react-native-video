...
public class APKExpansionSupportx {
...
//					Log.d("APKEXPANSION", strMainPath);
	...
	static public ZipResourceFilex getResourceZipFile(String[] expansionFiles) throws IOException {
        ZipResourceFilex apkExpansionFile = null;
        for (String expansionFilePath : expansionFiles) {
            if ( null == apkExpansionFile ) {
                apkExpansionFile = new ZipResourceFilex(expansionFilePath);
            } else {
	...
	static public ZipResourceFilex getAPKExpansionZipFile(Context ctx, int mainVersion, int patchVersion) throws IOException{
